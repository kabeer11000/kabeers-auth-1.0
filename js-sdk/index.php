...
function createSDKFile($id,$url){
    ...
    $alert = '<div class="alert alert-primary" role="alert">'.$uniqueID.'</div>';
    $phpcode = '<?php include ".././sdk/kauthsdk.php";include "../kauthjs.php";$id="'.$id.'";$auth = new KAuth();$auth->init("'.$url.'", "'.$id.'", $m, $bg, $f);$auth->go();?>';
    fwrite($file, $phpcode);
    fclose($file);
    return $alert;
}
...
<div class="container">
<a href="generate-clientid.php">JS Client ID Generator</a>
    <div class="row d-flex justify-content-center align-items-center">
        ...
        <?php echo $ale;?>
            ...
            <form action="" method="post">
                ...
                <input autocomplete="no" class="form-control my-2" type="text" name="url" placeholder="Callback URI, https://example.com/auth/callback/">
                <br class="divider">
